...
const CTASection = () => {
  return (
    <section className="relative w-full overflow-hidden bg-[#1a5b4d] py-16 md:py-20">
      <div className="container mx-auto flex max-w-7xl flex-col gap-10 px-4 sm:px-6 lg:flex-row lg:items-center lg:gap-12 lg:px-8">
        ...
        <div className="flex flex-1 flex-col lg:max-w-[60%]">
          <div className="mb-4 inline-flex w-fit items-center gap-2 rounded-full border border-[#1a5b4d] bg-white px-4 py-2">
          ...
          <h2 className="mb-4 font-heading text-3xl font-medium leading-tight text-white md:text-4xl lg:text-[3.5rem]">
            Every significant outcome begins with a conversation.
          </h2>

          <p className="mb-8 max-w-xl text-base text-[#d1d5db] md:text-lg">
            Stop guessing. Start building with precision. Our strategists are ready when you are.
          </p>

          <Link
            href="/contact"
            className="inline-flex w-fit items-center gap-2 rounded-full bg-[#34d399] px-6 py-3.5 text-base font-medium text-[#1a5b4d] shadow-sm transition-colors hover:bg-[#2dd4a0]"
          >
            Join Our Team
